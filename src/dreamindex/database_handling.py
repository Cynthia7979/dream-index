...
class Database:
    def __init__(self, database_path):
        ...
        # self.logger.info(os.path.exists(database_path), database_path, os.path._getfullpathname(database_path))
    ...
    def setup(self, overwrite=False):
        ...
        try:
            ...
            self.logger.error('One table already exists. Setup process is stopped. '
                              'If you want to overwrite it, use setup(True).')
